...
export default function GrafMorte() {

    const [dadosMortes, setDadosMortes] = React.useState([]);
        ...
        datasets: [
            {
                ...
                borderWidth: 2,
                lineTension: 1,
                data: dadosMortes.map(x => x.mortes),
            },
        ],
    }

    const graphCaseMorteOpt = {
        enabled: true,
